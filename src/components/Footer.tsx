            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110"
                >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <div className="text-muted-foreground text-sm">
                  <a href="tel:+94817798555" className="hover:text-primary transition-colors">
                    +94 81 779 8555
                  </a>
                  <span className="mx-2">/</span>
                  <a href="tel:743918805" className="hover:text-primary transition-colors">
                    7439 18805
                  </a>
                </div>
              </li>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              © {new Date().getFullYear()} Muve Mobility. All rights reserved.
            </p>
